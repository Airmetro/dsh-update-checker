...
try {
  ...
  const EXPECTED = [
    ...
    "/dsh-update-checker/backup-settings.json",
    "/dsh-update-checker/backup-root",
    "/dsh-update-checker/backups-clear",
    "/dsh-update-checker/backup-folder-pick",
    "/dsh-update-checker/backup-folder-open",
