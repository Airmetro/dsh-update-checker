...
function mainUpdatePlatformError(platform = process.platform) {
  if (platform === "win32") return null;
  return {
    code: "E_PLATFORM_UNSUPPORTED",
    error:
      "One-click core updates are unsupported on Linux/macOS. Stop DSH, update it manually, then restart DSH.",
  };
}
