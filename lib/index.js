...
let npmGlobalRootProbed = false;
async function probeNpmGlobalRoot() {
  if (npmGlobalRootProbed) return npmGlobalRootCache;
  npmGlobalRootProbed = true;
      ...
      webServer.register({
        ...
        handler: async (req, res) => {
          ...
          try {
            ...
            const inner = `Start-Process -WindowStyle Hidden -FilePath '${process.execPath}' -ArgumentList '${scriptPath}'`;
            const child = spawn(
              "C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe",
